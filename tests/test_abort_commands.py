...
@pytest.fixture(scope="function")
def command_default(robot, gear_feeder_default, winch_default, drivetrain_default):
...
def test_init_full(robot, gear_feeder_default, winch_default, drivetrain_default):
    robot.gear_feeder = gear_feeder_default
    robot.winch = winch_default
    robot.drivetrain = drivetrain_default
    ...
    assert abrt.robot.gear_feeder is not None
...
def test_execute(robot, hal_data, gear_feeder_default, winch_default, drivetrain_default):
    robot.gear_feeder = gear_feeder_default
    robot.winch = winch_default
    robot.drivetrain = drivetrain_default
